...
class ChartsService implements Arrayable, Jsonable, JsonSerializable
{
    ...
    protected mixed $group_by_field;

    protected mixed $group_by_period;

    protected mixed $filter_by_field;

    protected mixed $filter_by_period;

    protected array $usedColors = [];

    protected $colorSet;

    protected mixed $aggregate_function;

    protected mixed $aggregate_field;
    ...
    public function setAttr(string $key, $value): void
    {
